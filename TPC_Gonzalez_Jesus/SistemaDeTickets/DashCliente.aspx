<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DashCliente.aspx.cs" Inherits="SistemaDeTickets.DashCliente" %>
        ...
        <section class="d-flex">
            <div id="sidebar-container" style="background-color: #e3f2fd;">
                ...
                <div class="menu">
                   ...
                   <%-- <a href="#" runat="server" ID="c_DashBoard" onserverclick=" " style="text-decoration:none; color:black" class="d-block font-weight-bold p-3">
                       <i class = "icon ion-md-apps mr-2 lead"></i>Dashboard </a>--%>
                    ...
                    <a href="#" style="text-decoration:none; color:black" class="d-block font-weight-bold p-3"><i class = "icon ion-md-leaf mr-2 lead" ></i>Create tkt</a>
            ...
            <%--    <table ID="dg_Tickets">
               ...
               <%--<asp:DataGrid runat="server" ID="dg_TktCliente"
                    PageSize="10" AllowPaging="True" DataKeyField="ticketid" AutoGenerateColumns="False" CellPadding="4"
                    ForeColor="black" GridLines="Both" OnItemCommand=" " BorderColor="white">
                    <Columns>
